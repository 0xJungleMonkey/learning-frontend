...
def PollNeighbours(prefix,CaseNum,neighbours=10,processingStr="we received your Form I-765"):
    ...
    for i in range(neighbours):
        ...
        if(CaseNumIter != CaseNum):
            print("checking USCIS for Reciept: "+prefix+str(CaseNumIter))
            if processingStr in requestStatus(prefix+str(CaseNumIter)):
                processingCount+=1
                time.sleep(1.5)

    print(str(processingCount)+" out of "+str(neighbours)+" filed around your file date are still pending, don't give up!"+"\n")
    # print("")
...
if __name__ == "__main__":
    ...
    if(Args_N is None):
        ...
        PollNeighbours(prefix,CaseNum,neighbours=Args_N,processingStr="we received your Form I-765")
